estações = {91.9:'Teresina Fm', 93.5:'Mix', 94.1: 'Boa', 99.9:'Clube'}
i= 0
...
class RadioFM:
  ...
  def ligar(self):
    if self.__ligado == False:
      ...
      self.frequencia_atual = 91.9
      self.estação_atual = estações[91.9]
    else:
